...
<html lang="en">
    ...
    <head>
        ...
        <meta content="Fendi_S0709" name="author" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        <!-- BEGIN HEADER -->
        <?php $this->load->view('v_nav_header.php'); ?>
        <!-- END HEADER -->
        ...
        <div class="page-container">
            <!-- BEGIN SIDEBAR -->
            <?php $this->load->view('v_nav_sidebar'); ?>
            <!-- END SIDEBAR -->
            <!-- BEGIN CONTENT -->
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h3 class="page-title"> Dashboard
                        <small>Data Tukang, Pelanggan, dan Perhitungan Metode</small>
                    </h3>
                    <div class="page-bar">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 blue" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Data Tukang </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                                ...
                                <div class="details">
                                    ...
                                    <div class="desc"> Data Pengguna </div>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <!-- END CONTAINER -->
        <!-- BEGIN FOOTER -->
        <?php $this->load->view('v_nav_footer'); ?>
        <!-- END FOOTER -->
        <!--[if lt IE 9]>
